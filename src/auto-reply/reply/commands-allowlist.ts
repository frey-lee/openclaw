...
export const handleAllowlistCommand: CommandHandler = async (params, allowTextCommands) => {
  ...
  if (parsed.action === "list") {
    ...
    // Channel-specific allowlist resolution was removed along with channel directories.
    // The dock-based formatAllowFrom path in normalizeAllowFrom handles formatting
    // for any remaining channels via the plugin system.
