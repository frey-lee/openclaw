...
// Channel send function types (channels removed; types kept for OutboundSendDeps API)
type ChannelSendFn = (
  to: string,
  text: string,
...
export type OutboundSendDeps = {
  sendWhatsApp?: ChannelSendFn;
  sendTelegram?: ChannelSendFn;
  sendDiscord?: ChannelSendFn;
  sendSlack?: ChannelSendFn;
  sendSignal?: ChannelSendFn;
  sendIMessage?: ChannelSendFn;
